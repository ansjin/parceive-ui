UPDATE Call SET CallGroup=(SELECT g.Id FROM CallGroup g WHERE g.Caller = Call.Caller AND g.Function = Call.Function AND Call.Thread = g.Thread) WHERE Call.Caller IS NOT NULL;
UPDATE Call SET CallGroup=(SELECT g.Id FROM CallGroup g WHERE Call.Function = g.Function AND Call.Thread = g.Thread) WHERE Call.Caller IS NULL;
